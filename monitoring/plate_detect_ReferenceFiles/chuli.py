...
class App(ttk.Frame):
    ...
    def __init__(self,):
        ...
        self.root.minsize(App.width,App.heigh)
        ...
        #显示分离后的车牌字符
        frame_5111 = ttk.Frame(self.root)
    ...
    def close_window(self):
        uu = ['source/tmp/'+i for i in os.listdir('source/tmp/')]
        for i in uu:
            os.remove(i)
        print("destroy")
        self.root.destroy()
